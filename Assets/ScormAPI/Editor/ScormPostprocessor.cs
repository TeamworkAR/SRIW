...
namespace Scorm.Editor {
    ...
    public class ScormPostprocessor : IPostprocessBuildWithReport {
        ...
        public string CreateScormPackage(string path)
        {
        ...
        public void OnPostprocessBuild(BuildReport report)
        {
            ...
            // Package creation is called manually. Doing this as a build post process did not work well with the <see cref="DualBuild"/>
            // CreateScormPackage(report.summary.outputPath);
        }
