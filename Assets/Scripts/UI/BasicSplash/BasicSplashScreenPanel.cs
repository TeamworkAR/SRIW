...
{
    public class BasicSplashScreenPanel : BaseUICanvasGroup
    {
        ...
        private BasicSplashScreenData m_Data = null;
        ...
        public void Show(BasicSplashScreenData data)
        {
            m_Data = data;
        ...
        private IEnumerator COR_LifeCycle()
        {
            ...
            {
                m_Text.text = localizedString.GetLocalizedString();
        ...
        [Serializable]
        public class BasicSplashScreenData
        {
